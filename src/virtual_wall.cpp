...
void VirtualWall::onInitialize()
{
    ...
    // matchSize();
    // delete_wall_server_ = g_nh.advertiseService("DeleteVirtualWall",&VirtualWall::DeleteWallCallback,this);
    // get_wall_server_ = g_nh.advertiseService("GetVirtualWall",&VirtualWall::GetWallCallback,this);
}
